...
const TokenBalance: React.FC<TokenBalanceProps> = ({ contractAddress }) => {
  ...
  useEffect(() => {
    const fetchBalance = async () => {
      ...
      try {
        ...
        // Convert balance to string with 18 decimals (adjust if your token uses different decimals)
